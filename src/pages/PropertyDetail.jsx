...
import { propertiesApi, usersApi } from '../api/index'
...
export default function PropertyDetail() {
  ...
  const leadMutation = useMutation({
    mutationFn: (data) => usersApi.submitLead(data),
      ...
      <div className="space-y-4">
        ...
        <div className="card p-5 sticky top-20">
          ...
          <a
            ...
            onClick={() => usersApi.submitLead({ property_id: p.id, name: 'WhatsApp', phone: '0000000000', source: 'whatsapp' }).catch(() => {})}

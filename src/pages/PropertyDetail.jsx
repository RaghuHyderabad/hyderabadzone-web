      ...
      <div className="max-w-7xl mx-auto px-4 py-8" style={{minHeight:"100vh"}}>
        ...
        {p.status === 'sold' && (
          <div className="bg-red-50 border-2 border-red-400 rounded-2xl p-4 mb-6 flex items-center gap-3">
            <div className="bg-red-600 text-white font-bold text-sm px-4 py-2 rounded-xl tracking-widest flex-shrink-0">
              SOLD
            </div>
            <div>
              ...
              <p className="text-sm text-red-500">
                ...
                Browse similar properties in{' '}
                <Link to={`/${p.location?.slug}`} className="underline font-medium">
                  {p.location?.name}
                </Link>.
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* EMI Calculator - only for non-sold */}
            {p.status !== 'sold' && (
          ...
          <div className="space-y-4">
            <div className="card p-5 sticky top-20">
              ...
              {p.status === 'sold' ? (
                /* Sold - show similar properties CTA */
                <div className="text-center">
                  <div className="bg-red-50 border border-red-200 rounded-xl p-4 mb-4">
                    <p className="text-red-600 font-semibold text-sm">🔴 Property Sold</p>
                    <p className="text-red-400 text-xs mt-1">This property is no longer available</p>
                  </div>
